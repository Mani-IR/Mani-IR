...
# 💫 About Me:
I'm a passionate Developer and Python learner working my way toward AI & Machine Learning.<br>I build real-world web applications using both front-end & back-end, and I love mixing coding with fitness as a balanced lifestyle.<br>Always learning, always building.<br><br>🔭 Currently working on: Django, Python, API development<br>🎯 Goals: Master Django REST, enter the AI world, build ML-powered apps<br>🎨 Also a Web Designer & Figma enthusiast<br>💪 Athlete (Gym + Hiking)<br>🌍 Tech is my lifestyle, not just a skill


## 🌐 Socials:
[![Instagram](https://img.shields.io/badge/Instagram-%23E4405F.svg?logo=Instagram&logoColor=white)](https://instagram.com/deepcode_mi) 
...
![](https://github-contributor-stats.vercel.app/api?username=Mani-IR&limit=5&theme=tokyonight&combine_all_yearly_contributions=true)

---
[![](https://visitcount.itsvg.in/api?id=Mani-IR&icon=0&color=0)](https://visitcount.itsvg.in)
...
- 🔭 Currently working on: Django, Python, API development  
- 🎯 Goals: Master Django REST, enter the AI world, build ML-powered apps  
